...
class TaskManager {
  ...
  private toggleDone(id: string, titleElem: HTMLElement, descElem: HTMLElement): void {
  ...
  private editTask(id: string, titleElem: HTMLElement, descElem: HTMLElement): void {
    const task = this.tasks.find((t) => t.id === id);
    if (!task) return;
  ...
  private deleteTask(id: string, listItem: HTMLLIElement): void {
